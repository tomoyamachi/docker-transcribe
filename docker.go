...
import (
	...
	cliflags "github.com/tomoyamachi/docker"
)
...
func main() {
	...
	if *flHelp {
		// if global flag --help is present, regardless of what other options and commands there are, just print the usage
		flag.Usage()
		return
	}
  ...
  c := cli.New(clientCli, New DaemonProxy())
  // 受け取ったflagにエラーがあればエラーを返す
